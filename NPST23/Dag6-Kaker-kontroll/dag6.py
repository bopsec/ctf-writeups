...
# Splitting the text at each ZWJ
segment_split = message.split("\u200d")

# Extracting the first letter of each segment
first_letters_of_segments = ''.join([segment[0] if segment else '' for segment in segment_split])

print(first_letters_of_segments)
